                ...
                <Grid item className={classes.upper} xs={12} sm={12}>
                    <div className={classes.rlArea}>
                        <Grid container justify="center">
                            <Grid item >
                                <Link to={"/login"} className="clearAll" style={{ color: 'inherit', textDecoration: 'inherit' }}>
                                    <Fab variant="extended" aria-label="add" className={classes.margin} onClick={login}>
                            ...
                            <Grid item xs={12} />
                            <Grid item >
                                <Link to={"/register"} className="clearAll" style={{ color: 'inherit', textDecoration: 'inherit' }}>
                                    <Fab variant="extended" aria-label="add" className={classes.margin} onClick={register}>
